...
namespace LUISPractice.Model
{
    public class Str
    {
        ...
        public const string cStrProcessingReq = "Thanks for using our service. Deliver has been schedule for: ";

        public const string cStrDontUnderstand = "I'm sorry I don't know what you mean.";
    ...
    {
        public static string CakeType = string.Empty;
    ...
    public class Cakes
    {
        ...
        public static IForm<Cakes> BuildForm()
        {
            OnCompletionAsyncDelegate<Cakes> processOrder = async (context, state) =>
            {
                ...
                await context.PostAsync($"{Str.cStrProcessingReq} {Validate.CakeType}");
            };
